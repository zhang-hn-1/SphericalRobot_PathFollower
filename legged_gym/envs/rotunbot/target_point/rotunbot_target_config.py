...
class RotunbotTargetCfg( LeggedRobotCfg ):
    """
    ...
    class env( LeggedRobotCfg.env ):
        ...
        # num_actions = 12
        episode_length_s = 90 #episode length in seconds #100
...
class RotunbotTargetCfgPPO(LeggedRobotCfgPPO):
    seed = 3
