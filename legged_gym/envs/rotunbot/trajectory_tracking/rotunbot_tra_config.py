...
class RotunbotTrajectoryCfg( LeggedRobotCfg ):
    """
...
class RotunbotTrajectoryCfgPPO(LeggedRobotCfgPPO):
    ...
    class policy(LeggedRobotCfgPPO.policy):
        ...
        in_channels = RotunbotTrajectoryCfg.env.frame_stack
